...
function buildInlineEmbedSnippet(payload, options = {}) {
  ...
  return `<iframe title="${payload.name} ASCII Animation" loading="lazy" referrerpolicy="no-referrer" sandbox="allow-scripts" scrolling="no" style="width:100%;max-width:100%;height:${estimatedHeight}px;border:0;display:block;background:#000;overflow:hidden" srcdoc="${srcdoc}"></iframe>
